...
const ALL_POSSIBLE_BADGES = [
  ...
  { id: 'alienigena', icon: '👽', title: 'Alienígena', desc: 'Acertou o placar exato 3 vezes' },
  ...
  { id: 'hat_trick', icon: '⚽', title: 'Hat-trick', desc: 'Acertou o vencedor de um jogo onde houve um hat trick' },
